...
#     batchId = VoucherInland().grantVoucher("2031", "KB_COUPON", "DIKOU", "10", "6.66", "2086653073")
    batchId = VoucherInland().grantVoucher("2031", "KB_COUPON", "DIKOU", "10", "6.66", "2086100900")
    VoucherInland().checkVoucher(batchId)
