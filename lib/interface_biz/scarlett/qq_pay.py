...
def qq_refund_mock_scarlett():
    ...
    qq_refund_info = {
        ...
        "appid": "1104946420",
        "mch_id": "1282256301",
        "nonce_str": "5d9062b72e65846f8b9b0a6e176ecce9",
        ...
        "refund_fee": "1",
        "refund_id": "12822563017012202103021639413456",
        "result_code": "SUCCESS",
        "sign": "",
        "total_fee": "1",
        "transaction_id": "12822563016012202103021548430031"
    }
    print(qq_mock_refund_to_xml(qq_refund_info, "46b3da6ee122993430adb1f7e20c4327"))
    # qq_refund_info['sign'] = ""
    # req_scarlet = ""
    # req_scarlet = (qq_pay_to_xml(req_scarlet, "46b3da6ee122993430adb1f7e20c4327"))
    # response = requests.post("127.0.0.1" + "/opaycenter/qqpayNotifycation",
    #                          data=req_scarlet.encode("utf-8"))
    # result = response.content
    # logger.info(str(result.decode("utf-8")))
