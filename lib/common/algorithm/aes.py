...
if __name__ == '__main__':
    os.urandom(16)
    a = AES_CBC(os.urandom(16), os.urandom(16)).encrypt('{"imei":"","mac":"0","serialNum":"unknown","serial":"unknown","hasPermission":true,"wifissid":"<unknown ssid>","deviceName":"PEDM00","slot1":"{}"}')
    print(a)
